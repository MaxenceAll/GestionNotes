...
namespace GestionNotes
{
    public partial class FormGestion : Form
    {
        ...
        private void buttonAjouterEleve_Click(object sender, EventArgs e)
        {
            ...
            int age = Convert.ToInt32(textBoxEleveAge.Text);
            Eleve nouvelEleve = new Eleve(nom, prenom, age);
        ...
        private void buttonChargerListeEleve_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i<toLoad.Length; i++)
            {
                ...
                int newAge          = Convert.ToInt32(aDecomposer[2]);
                listeEleves.Add(new Eleve(newNom, newPrenom, newAge));
                majDataGridView();
            }
        }
    }
